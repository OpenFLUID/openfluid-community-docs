...
It is illustrated on a MHYDAS model (see [Installation](../models/mhydas)] or [MHYDAS presentation ](http://www.umr-lisah.fr/openfluid/index.php?page=mhydas&lang=fr) for more details). This MHYDAS model is applied on a virtual catchment composed of 9 spatial units : 6 parcels (SUs) and 3 ditches (RSs) (see figure 1).
